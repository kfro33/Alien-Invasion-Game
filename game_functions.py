...
def fire_bullet(ai_settings, screen, ship, bullets):
    ...
    # As long as bullet limit isn't reached yet
...
def update_screen(ai_settings, screen, stats, sb, play_button, ship,
                  aliens, bullets):
...
def check_bullet_alien_collisions(ai_settings, screen, stats, sb, ship,
    ...
    if len(aliens) == 0:
        ...
        # create new fleet, and start a new level.
        bullets.empty()
...
def change_fleet_direction(ai_settings, aliens):
    # Drope the entire fleet and change the fleet's direction.
    for alien in aliens.sprites():
...
def update_aliens(ai_settings, screen, stats, sb, ship, aliens, bullets):
    ...
    # Look for alien's hitting the bottom of the screen.
